...
def source_func_2(Node,Umin = 0.8,Alpha=0.5,fig=f):
    ...
    if THEM_LIEN_KET == 1:
        ...
        while maxHop >= 1:
            ...
            if Traffic_Backbone[a,b]:
                ...
                #     # print(temp_y_node)
                #     plt.plot(temp_x_node,temp_y_node,color='green',linewidth=3)
                #     ultis.append([Backbone_node[a] ,Backbone_node[b] ,n ,U ,cost[Backbone_node[a]-1,Backbone_node[b]-1], cost[Backbone_node[a]-1,Backbone_node[b]-1]*n ])
...
if __name__ == '__main__':
    f,ax = source_func_2(Node,umin,alpha,fig=f)
